...
return [
    'hero' => [
        'title' => 'Modern Developer Program — <span class="course-hero__title-accent">Job Transformation</span> Track',
        ...
        'ctas' => [
            [
                'label' => 'Modern Developer Program Batch -1 Apply করুন',
                'link' => '',
                'class' => 'primary-btn',
            ],
        ],
        ...
        'microcopy' => 'Seats left: {{SEAT_REMAINING}} | Early Bird: Ramadan er moddhe',
    ],
    'why' => [
    ...
    'portfolio_support' => [
        ...
        'dates_line' => 'Program Start: 5–10 April 2026 | Early Bird Enrollment Deadline: Ramadan er moddhe | Seats left: {{SEAT_REMAINING}}',
        'cta_text' => 'Launch My Portfolio',
        'microcopy' => 'Early Bird fee: ৳ 6,999/=',
    ],
    'interview' => [
    ...
    'pricing' => [
        ...
        'note' => 'Early Bird: Ramadan er moddhe',
        'cta' => 'Seat বুক করুন',
    ],
    'enrollment' => [
    ...
    'final_cta' => [
        ...
        'subtitle' => 'Next batch starts 5–10 April 2026 — seats only {{SEAT_REMAINING}}',
        'cta' => 'Apply Now',
