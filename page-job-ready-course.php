        ...
        <div class="course-cta-block">
            ...
            <div class="course-cta__actions">
                <?php if ($primary && !empty($primary['link'])) : ?>
                    <a class="<?php echo esc_attr($primary['class'] ?? 'primary-btn'); ?>" href="<?php echo esc_url($primary['link']); ?>">
                        <?php echo esc_html($primary['label']); ?>
                    </a>
                <?php endif; ?>
                <?php if ($secondary && !empty($secondary['link'])) : ?>
                    <a class="<?php echo esc_attr($secondary['class'] ?? 'secondary-btn'); ?>" href="<?php echo esc_url($secondary['link']); ?>">
    ...
    <section class="section course-hero" id="hero">
        <div class="container course-hero__grid">
            <div class="course-hero__content">
                ...
                <?php if ($quiz_available) : ?>
                    <div class="course-highlight course-highlight--quiz">
                        ...
                        <p class="course-highlight__text"><?php echo esc_html($course['hero']['quiz_note'] ?? 'Basic test helps us review your current foundation.'); ?></p>
                    </div>
                <?php endif; ?>
                <div class="course-hero__actions">
                    <?php foreach ($hero_ctas as $cta) : ?>
                        <a class="<?php echo esc_attr($cta['class']); ?>" href="<?php echo esc_url($cta['link']); ?>">
            ...
            <div class="course-hero__card">
                <h2 class="course-hero__card-title"><?php echo esc_html($course['hero']['card_title'] ?? 'Quick Info'); ?></h2>
        ...
        <section class="section course-section course-why" id="why-program">
            <div class="container">
                ...
                <div class="course-cta">
                    ...
                    <?php if ($primary_cta) : ?>
                        <div class="course-cta__actions">
                            <a class="primary-btn" href="<?php echo esc_url($primary_cta['link']); ?>">
                    ...
                    <?php foreach ($course['tracks']['items'] as $track) : ?>
                        <div class="course-card">
                            ...
                            <?php if (!empty($track['cta']) && $primary_cta) : ?>
                                <div class="course-cta__actions">
                                    <a class="secondary-btn" href="<?php echo esc_url($primary_cta['link']); ?>">
            ...
            <div class="container">
                ...
                <div class="course-grid course-grid--two">
                    <?php foreach ($course['course_paths']['items'] as $item) : ?>
                        ...
                        ?>
                        <div class="course-card jrc-course-card" data-course="<?php echo esc_attr($key); ?>" data-course-label="<?php echo esc_attr($item['title'] ?? 'Course'); ?>">
                            ...
                            <?php if (!empty($item['cta_link']) && !empty($item['cta_label'])) : ?>
                                <div class="course-cta__actions">
                                    <a class="secondary-btn" href="<?php echo esc_url($item['cta_link']); ?>">
                            ...
                            <?php if (!empty($key)) : ?>
                                <div class="course-cta__actions">
                                    <button type="button" class="primary-btn jrc-course-select" data-course="<?php echo esc_attr($key); ?>" data-course-label="<?php echo esc_attr($item['title'] ?? 'Course'); ?>">Select This Path</button>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                        ...
                        <div class="curriculum-card">
                            <div class="curriculum-card__header">
                                <span class="curriculum-icon <?php echo $path_key ? 'is-' . esc_attr($path_key) : ''; ?>" aria-hidden="true">
                                    ...
                                    <?php elseif ($path_key === 'cursor_mastery') : ?>
                                        <svg viewBox="0 0 64 64" focusable="false" aria-hidden="true">
                                            <path d="M14 10l28 18-12 4 8 18-8 4-8-18-10 8V10z" fill="currentColor"></path>
                                            <path d="M44 14h10M44 24h8M44 34h10" stroke="currentColor" stroke-width="4" stroke-linecap="round" fill="none"></path>
                                        </svg>
                                    <?php else : ?>
                            ...
                            <?php if (!empty($path['cta_label']) && !empty($path_key)) : ?>
                                <div class="course-cta__actions">
                                    <button type="button" class="primary-btn jrc-course-select" data-course="<?php echo esc_attr($path_key); ?>" data-course-label="<?php echo esc_attr($path['title'] ?? 'Course'); ?>">
        ...
        <section class="section course-section course-pricing" id="pricing">
            <div class="container">
                ...
                <div class="course-price">
                    ...
                    <div class="course-price__item">
                        <span><?php echo esc_html($pricing['discount_label'] ?? 'Discounted Price'); ?></span>
            ...
            <div class="container course-discount__grid">
                ...
                <div class="course-discount__card">
                    <div class="course-highlight">
                        ...
                        <p class="course-highlight__text"><?php echo esc_html($course['discount_hook']['cta_text'] ?? 'Complete the test and continue to the next step.'); ?></p>
                    </div>
                    <?php if ($quiz_available) : ?>
                        <div class="course-cta__actions">
                            <a class="primary-btn" href="<?php echo esc_url($quiz_cta_link); ?>">
    ...
    <?php if (!empty($course['enrollment_process'])) : ?>
        <section class="section course-section course-process" id="enrollment-process">
            <div class="container">
                ...
                jrc_render_cta_block(
                    'Ready to start?',
                    'Complete the basic test and continue to the next step.',
                    $process_primary,
                    $process_secondary
                );
                ?>
            ...
            <div class="container">
                <div class="section-heading">
                    ...
                    <p class="section-subtitle">
                        <?php
                        $selection_note = $course['course_paths']['selection_note'] ?? 'Select your course and submit the form.';
                        if (!is_user_logged_in()) {
                            $selection_note .= ' Sign up or log in first to apply.';
                        }
                        echo esc_html($selection_note);
                        ?>
                    </p>
                    <?php if (!is_user_logged_in() && function_exists('jrc_get_auth_page_url')) : ?>
                        <?php $selected_auth_course = function_exists('jrc_get_requested_course_key') ? jrc_get_requested_course_key() : ''; ?>
                        <div class="jrc-application-auth-links">
                            <a class="primary-btn" href="<?php echo esc_url(jrc_get_auth_page_url('signup', $selected_auth_course)); ?>">Sign Up To Apply</a>
                            <a class="secondary-btn" href="<?php echo esc_url(jrc_get_auth_page_url('login', $selected_auth_course)); ?>">Already Have An Account? Login</a>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="course-card">
...
<script>
    (function () {
        ...
        var authCourseInputs = document.querySelectorAll('.jrc-auth-course-input');
        var authCourseLabels = document.querySelectorAll('[data-jrc-auth-course-label]');
        var selectedCourseLabels = document.querySelectorAll('[data-jrc-selected-course-label]');
        var authCourseNotes = document.querySelectorAll('.jrc-auth-course-notes .jrc-course-note');
        var courseLabelMap = {};

        document.querySelectorAll('[data-course][data-course-label]').forEach(function (item) {
            var key = item.getAttribute('data-course');
            var label = item.getAttribute('data-course-label');
            if (key && label && !courseLabelMap[key]) {
                courseLabelMap[key] = label;
            }
        });

        document.querySelectorAll('.jrc-application-form input[name="student_course"]').forEach(function (input) {
            var optionLabel = input.closest('label');
            var labelText = optionLabel ? optionLabel.textContent.trim() : '';
            if (input.value && labelText && !courseLabelMap[input.value]) {
                courseLabelMap[input.value] = labelText;
            }
        });

        function updateStandaloneCourseSelection(value) {
            var label = courseLabelMap[value] || 'Select a course above to continue';

            authCourseInputs.forEach(function (input) {
                input.value = value;
            });

            authCourseLabels.forEach(function (item) {
                item.textContent = label;
            });

            selectedCourseLabels.forEach(function (item) {
                item.textContent = label;
            });

            authCourseNotes.forEach(function (note) {
                note.classList.toggle('is-active', note.getAttribute('data-course') === value);
            });
        }
        ...
        function setCourseSelection(value, shouldScroll) {
            ...
            updateStandaloneCourseSelection(value);
            courseCards.forEach(function (card) {
        ...
        if (!initialSelection) {
            initialSelection = document.querySelector('.jrc-auth-course-input');
        }
        if (initialSelection) {
