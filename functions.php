...
add_action('customize_register', function (WP_Customize_Manager $wp_customize) {
    ...
    $wp_customize->add_setting('jrc_google_form_link', [
        'default' => '[GOOGLE_FORM_LINK]',
        'sanitize_callback' => 'esc_url_raw',
    ]);
    $wp_customize->add_control('jrc_google_form_link', [
        'label' => 'Apply Button Link (Google Form)',
        'section' => 'khokan_job_ready_course',
        'type' => 'url',
    ]);

    $wp_customize->add_setting('jrc_whatsapp_link', [
        'default' => '[WHATSAPP_LINK]',
        'sanitize_callback' => 'esc_url_raw',
    ]);
    $wp_customize->add_control('jrc_whatsapp_link', [
        'label' => 'WhatsApp Link',
        'section' => 'khokan_job_ready_course',
        'type' => 'url',
    ]);

    $wp_customize->add_setting('jrc_start_date', [
        'default' => '[START_DATE]',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('jrc_start_date', [
        'label' => 'Start Date',
        'section' => 'khokan_job_ready_course',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('jrc_class_time', [
        'default' => '[CLASS_TIME_OPTIONS]',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('jrc_class_time', [
        'label' => 'Class Time Options',
        'section' => 'khokan_job_ready_course',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('jrc_seat_limit', [
        'default' => '30',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('jrc_seat_limit', [
        'label' => 'Seat Limit',
        'section' => 'khokan_job_ready_course',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('jrc_fee_standard', [
        'default' => '৳ 9,999',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('jrc_fee_standard', [
        'label' => 'Standard Fee',
        'section' => 'khokan_job_ready_course',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('jrc_fee_early', [
        'default' => '৳ 6,999 (limited seats)',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('jrc_fee_early', [
...
function jrc_get_course_options()
{
    ...
    $options = array_merge([
        ...
        'hero_note' => 'Short, beginner-friendly line here.',
        'cta_apply_label' => $defaults['hero']['ctas'][0]['label'],
        'cta_apply_link' => $defaults['hero']['ctas'][0]['link'],
        'cta_whatsapp_label' => $defaults['hero']['ctas'][1]['label'],
        'cta_whatsapp_link' => $defaults['hero']['ctas'][1]['link'],
        ...
        'fee_note' => 'Optional note under fee.',
    ...
    return [
        'hero' => [
            ...
            'ctas' => [
                ...
                [
                    'label' => $options['cta_whatsapp_label'],
                    'link' => $options['cta_whatsapp_link'],
                    'class' => 'secondary-btn',
                ],
            ],
            'card' => [
        ...
        'faq' => jrc_faq_lines_to_array($options['faq_items'], $defaults['faq']),
        'faq_title' => $options['faq_title'],
        'final_cta' => [
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table" role="presentation">
                ...
                <tr><th scope="row">Apply Button Label</th><td><input class="regular-text" type="text" name="jrc_options[cta_apply_label]" value="<?php echo esc_attr($options['cta_apply_label']); ?>"></td></tr>
                <tr><th scope="row">Apply Button Link</th><td><input class="regular-text" type="url" name="jrc_options[cta_apply_link]" value="<?php echo esc_url($options['cta_apply_link']); ?>"></td></tr>
                <tr><th scope="row">WhatsApp Label</th><td><input class="regular-text" type="text" name="jrc_options[cta_whatsapp_label]" value="<?php echo esc_attr($options['cta_whatsapp_label']); ?>"></td></tr>
                <tr><th scope="row">WhatsApp Link</th><td><input class="regular-text" type="url" name="jrc_options[cta_whatsapp_link]" value="<?php echo esc_url($options['cta_whatsapp_link']); ?>"></td></tr>
...
<div class="wp-block-button primary-btn"><a class="wp-block-button__link primary-btn" href="[GOOGLE_FORM_LINK]">Apply Now</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"secondary-btn","linkClassName":"secondary-btn"} -->
<div class="wp-block-button secondary-btn"><a class="wp-block-button__link secondary-btn" href="[WHATSAPP_LINK]">WhatsApp</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
